...
public class Scene3App {
	...
	public Scene3App() {
		...
		button4.setLayoutY(316.0);
		
		button4.setPrefHeight(56.0);
		button4.setPrefWidth(108.0);
...
*/
		...
		imageView2.setLayoutY(120.0);
		imageView2.setPickOnBounds(true);
		imageView2.setPreserveRatio(true);
		imageView2.setImage(new Image(getClass().getResource("delete.png").toExternalForm()));
	
		imageView7.setFitHeight(25.0);
		imageView7.setFitWidth(34.0);
		imageView7.setLayoutX(82.0);
		imageView7.setLayoutY(190.0);
		imageView7.setPickOnBounds(true);
		imageView7.setPreserveRatio(true);
		imageView7.setImage(new Image(getClass().getResource("services.png").toExternalForm()));

		imageView3.setFitHeight(102.0);
		imageView3.setFitWidth(223.0);
		imageView3.setLayoutX(32.0);
		imageView3.setLayoutY(36.0);
	...
	public void jumpService(Stage stage,Scene scene) {
		stage.setScene(scene);
	}
	...
	public void refresh () {
		button3.setOnAction(e->{
			...
			buildData("SELECT A.bookingID, A.bookingDate,A.bookingTime, A.duration, A.custId , C.fName ,c.lName ,A.staffID, S.serviceId, S.servicetype, ST.fname , st.lname   FROM APPOINTMENT A, SERVICE S, STAFF ST, CUSTOMER C WHERE A.serviceID=S.serviceID AND A.custID=C.custID AND S.staffID=ST.staffID ;",getTableView());
		});
	}
	...
	public void getServices(Stage stage, Scene scene) {
