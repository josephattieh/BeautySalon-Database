...
*/		pane.getChildren().add(button3);
	...
	public void refresh () {
		button3.setOnAction(e->{
			...
			buildData(" SELECT O.* , C.lName,fName FROM Order_data O, Customer C WHERE O.custId = C.custId; ",tableview) ;
	});}
	...
	public void getOrderDetails(Stage stage, Scene scene) {
	...
	public void goEdit(Stage stage, Scene scene) {
		button0.setOnAction(e->{
			stage.setScene(scene);
			stage.show();
		});
	}
	public Stage searchOrder(Scene scene) {
		Stage stage = new Stage();
